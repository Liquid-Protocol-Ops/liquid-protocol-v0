...
//  ╚══════╝╚═╝ ╚══▀▀═╝  ╚═════╝ ╚═╝╚═════╝
//
//  Liquid Protocol — Token Factory
//  https://github.com/Liquid-Protocol-Ops

import {LiquidDeployer} from "./utils/LiquidDeployer.sol";
...
contract Liquid is OwnerAdmins, ReentrancyGuard, ILiquid {
        ...
        returns (address tokenAddress)
    {
        ...
        // deploy the token
        tokenAddress = LiquidDeployer.deployToken(deploymentConfig.tokenConfig, TOKEN_SUPPLY);
