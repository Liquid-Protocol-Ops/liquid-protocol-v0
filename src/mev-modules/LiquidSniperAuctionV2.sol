...
import {ILiquidFeeLocker} from "../interfaces/ILiquidFeeLocker.sol";
...
contract LiquidSniperAuctionV2 is
    ReentrancyGuard,
    ...
    Ownable
{
        ...
        view
    {
        ...
        if (
            !ILiquidHookV2(address(poolKey.hooks)).supportsInterface(
        ...
        onlyHook(poolKey)
    {
        ...
        ILiquidMevDescendingFees.FeeConfig memory feeConfigData =
            abi.decode(descendingFeeConfig, (ILiquidMevDescendingFees.FeeConfig));
    ...
    function _setLpFee(PoolKey calldata poolKey, uint24 lpFee) internal {
        ...
        ILiquidHookV2(msg.sender).mevModuleSetFee(poolKey, lpFee);
    }
