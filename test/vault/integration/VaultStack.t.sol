...
contract VaultStackIntegrationTest is Test {
    ...
    function setUp() public {
        ...
        vm.prank(alice); IERC20(VVV).approve(address(router), type(uint256).max);
        vm.prank(alice); IERC20(DIEM).approve(address(wrapper), type(uint256).max);
    }
    ...
    function test_e2e_creditDIEM_raisesRateForAllHolders() public {
        ...
        vm.prank(bob);   vault.deposit(500e18, bob);
