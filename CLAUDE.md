...
| Morpho Blue | `0xBBBBBbbBBb9cC5e90e3b3Af64bdAF62C37EEFFCb` | DIEM lending market (38.5% LLTV, wstDIEM collateral) |
| Curve DIEM/wstDIEM | `0x60b9bDfFE446A17202b0e56318ED3aE67bb2694E` | StableSwap exit pool |

**Active deployed addresses (Base mainnet):** see `docs/vault/mainnet-addresses.md`
